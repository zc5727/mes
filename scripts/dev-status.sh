...
if [[ -f "$RUNTIME_DIR/ports.env" ]]; then
  # This file is generated by dev-up.sh and contains only local port numbers.
  # Loading it keeps status checks aligned with an isolated runtime session.
