...
export interface MasterDataRecord { id: string; tenantId: string; code: string; name: string; type: 'product' | 'process' | 'shift' | 'calendar'; data: Record<string, unknown>; createdAt: string; updatedAt: string; }
...
export class MasterDataService {
  ...
  create(tenantId: string, type: MasterDataRecord['type'], dto: CreateProductDto | CreateProcessDto | CreateShiftDto | CreateCalendarDto): MasterDataRecord {
