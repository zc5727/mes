...
export interface PersistedReport { id: string; tenantId: string; workOrderId: string; deviceId: string | null; quantity: number; goodQty: number; defectQty: number; sourceTraceId: string; reportedAt: string }
