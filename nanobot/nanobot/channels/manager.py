...
class ChannelManager:
    ...
    def __init__(
        ...
        *,
        ...
        webui_registered_tools: Callable[[], list[dict[str, str]]] | None = None,
        ...
        self._webui_registered_tools = webui_registered_tools
        ...
        *,
        ...
        if cls.name == "websocket":
            ...
            gateway = build_gateway_services(
                ...
                registered_tools=self._webui_registered_tools,
